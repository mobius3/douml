...
const WrapperStr & UmlBaseActivity::preCondition()
{
    read_if_needed_();
...
const WrapperStr & UmlBaseActivity::postCondition()
{
    read_if_needed_();
...
#ifdef WITHCPP
const WrapperStr & UmlBaseActivity::cppPreCondition()
{
    read_if_needed_();
...
const WrapperStr & UmlBaseActivity::cppPostCondition()
{
    read_if_needed_();
...
#ifdef WITHJAVA
const WrapperStr & UmlBaseActivity::javaPreCondition()
{
    read_if_needed_();
...
const WrapperStr & UmlBaseActivity::javaPostCondition()
{
    read_if_needed_();
...
const WrapperStr & UmlBaseActivity::constraint()
{
    read_if_needed_();
    return _constraint;
}
