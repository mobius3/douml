...
public:
    ...
    const WrapperStr & transformation();
    ...
    const WrapperStr & cppTransformation();
    ...
    const WrapperStr & javaTransformation();
...
protected:
    ...
    UmlBaseFlow(void * id, const WrapperStr & s) : UmlItem(id, s) {
    }
