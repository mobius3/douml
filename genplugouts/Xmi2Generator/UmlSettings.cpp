...
bool UmlSettings::set_ArtifactDescription(WrapperStr v)
{
    UmlCom::send_cmd(umlSettingsCmd, setDefaultArtifactDescriptionCmd, (const char *)v); //[jasa] ambiguous call
...
WrapperStr UmlSettings::classDescription()
{
    read_if_needed_();
...
bool UmlSettings::set_ClassDescription(WrapperStr v)
{
    UmlCom::send_cmd(umlSettingsCmd, setDefaultClassDescriptionCmd, (const char *) v); //[jasa] ambiguous call
...
WrapperStr UmlSettings::operationDescription()
{
    read_if_needed_();
...
bool UmlSettings::set_OperationDescription(WrapperStr v)
{
    UmlCom::send_cmd(umlSettingsCmd, setDefaultOperationDescriptionCmd, (const char *)v); //[jasa] ambiguous call
...
WrapperStr UmlSettings::attributeDescription()
{
    read_if_needed_();
...
bool UmlSettings::set_AttributeDescription(WrapperStr v)
{
    UmlCom::send_cmd(umlSettingsCmd, setDefaultAttributeDescriptionCmd, (const char *) v); //[jasa] ambiguous call
...
WrapperStr UmlSettings::relationDescription()
{
    read_if_needed_();
...
bool UmlSettings::set_RelationDescription(WrapperStr v)
{
    UmlCom::send_cmd(umlSettingsCmd, setDefaultRelationDescriptionCmd, (const char *)v); //[jasa] ambiguous call
...
WrapperStr UmlSettings::_artifact_default_description;

WrapperStr UmlSettings::_class_default_description;

WrapperStr UmlSettings::_operation_default_description;

WrapperStr UmlSettings::_attribute_default_description;
...
WrapperStr UmlSettings::uml_type(const WrapperStr & t, WrapperStr UmlBuiltin::* f)
{
...
WrapperStr UmlSettings::uml_rel_attr_stereotype(const WrapperStr & t, WrapperStr UmlStereotype::* f)
{
...
WrapperStr UmlSettings::uml_class_stereotype(const WrapperStr & t, WrapperStr UmlStereotype::* f)
{
