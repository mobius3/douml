...
{
    UmlCom::send_cmd(_identifier, setNameCmd, (const char *)s); //[jasa] ambiguous call
...
bool UmlBaseItem::set_PropertyValue(const WrapperStr & k, const WrapperStr & v)
{
    ...
    UmlCom::send_cmd(_identifier, setCoupleValueCmd, (const char *)k, (const char *)v); //[jasa] ambiguous call
