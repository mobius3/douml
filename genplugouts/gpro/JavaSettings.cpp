...
const Q3CString & JavaSettings::enumDecl()
{
    read_if_needed_();
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaAttributeDeclCmd, (const char *)v); //[rageek] Fix prototype
...
const Q3CString & JavaSettings::enumItemDecl()
{
    read_if_needed_();
...
const Q3CString & JavaSettings::enumItemCase()
{
    read_if_needed_();
...
bool JavaSettings::set_EnumItemCase(Q3CString v)
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumItemCaseCmd, (const char *)v); //[rageek] Fix prototype
...
Q3CString JavaSettings::_enum_item_case;
