...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaAttributeDeclCmd, (const char *)v); //[jasa] ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumItemCaseCmd, (const char *)v); //[jasa] ambiguous call
