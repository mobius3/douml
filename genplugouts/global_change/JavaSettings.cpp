...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaTypeCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaRelationAttributeStereotypeCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaClassStereotypeCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaImportCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaRootdirCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaSourceContentCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaSourceExtensionCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaClassDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaExternalClassDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumPatternDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaInterfaceDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaAttributeDeclCmd, multiplicity, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumPatternItemDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumPatternItemCaseCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaEnumItemDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(javaSettingsCmd, setJavaRelationDeclCmd, multiplicity, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaOperationDefCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaGetNameCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(javaSettingsCmd, setJavaSetNameCmd, (const char *)v); //[jasa] handle ambiguous call
