...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppTypeCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppRelationAttributeStereotypeCmd, (const char *)s, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppClassStereotypeCmd, (const char *)s, (const char *)v);
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppIncludeCmd, (const char *)s, (const char *)v);
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppRootDirCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppHeaderContentCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppSourceContentCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppHeaderExtensionCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppSourceExtensionCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumInCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumOutCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumInOutCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumReturnCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppInCmd, (const char *)type, (const char *)form); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppOutCmd, (const char *)type, (const char *)form); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppInOutCmd, (const char *)type, (const char *)form); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppReturnCmd, (const char *)type, (const char *)form); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppInCmd, (const char *)v, ""); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppOutCmd, (const char *)v, ""); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppInOutCmd, (const char *)v, "");
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppReturnCmd, (const char *)v, ""); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppClassDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppExternalClassDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppStructDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppUnionDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppTypedefDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    read_if_needed_();
    UmlCom::send_cmd(cppSettingsCmd, setCppAttributeDeclCmd, multiplicity, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppEnumItemDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppOperationDeclCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppOperationDefCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppGetNameCmd, (const char *)v); //[jasa] handle ambiguous call
...
{
    UmlCom::send_cmd(cppSettingsCmd, setCppSetNameCmd, (const char *)v); //[jasa] handle ambiguous call
