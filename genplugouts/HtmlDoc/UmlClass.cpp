...
void UmlClass::generate(const QList<UmlActualParameter> a, UmlClass * mother, bool cpp)
{
    unsigned i;
    unsigned n = a.count();
...
void UmlClass::generate(const QList<UmlFormalParameter> f)
{
    unsigned n = f.count();
...
{
    QList<UmlFormalParameter> f = formals();
    unsigned n = f.count();
