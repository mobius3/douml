...
UmlPackage * UmlBasePackage::findCppNamespace(const Q3CString & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findJavaPackage(const Q3CString & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findPythonPackage(const Q3CString & n, const UmlBasePackage * p)
{
...
UmlPackage * UmlBasePackage::findIdlModule(const Q3CString & n, const UmlBasePackage * p)
{
