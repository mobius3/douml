...
public:
    ...
    static UmlPackage * findCppNamespace(const Q3CString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findJavaPackage(const Q3CString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findPythonPackage(const Q3CString & n, const UmlBasePackage * p = 0);
#endif
    ...
    // (including 'p' itself), else 0
    static UmlPackage * findIdlModule(const Q3CString & n, const UmlBasePackage * p = 0);
#endif
