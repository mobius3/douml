...
WrapperStr IdlSettings::type(WrapperStr s)
{
    ...
    UmlBuiltin * b = UmlSettings::_map_builtins.value(s, 0);
...
WrapperStr IdlSettings::relationAttributeStereotype(const WrapperStr & s)
{
    ...
    UmlStereotype * b = UmlSettings::_map_relation_attribute_stereotypes.value(s, 0);
...
bool IdlSettings::set_RelationAttributeStereotype(WrapperStr s, WrapperStr v)
{
    ...
    if (UmlCom::read_bool()) {
        UmlStereotype * st = UmlSettings::_map_relation_attribute_stereotypes.value(s, 0);
...
WrapperStr IdlSettings::classStereotype(WrapperStr s)
{
    ...
    UmlStereotype * b = UmlSettings::_map_class_stereotypes.value(s, 0);
...
bool IdlSettings::set_ClassStereotype(WrapperStr s, WrapperStr v)
{
    ...
    if (UmlCom::read_bool()) {
        UmlStereotype * st = UmlSettings::_map_class_stereotypes.value(s, 0);
...
QHash<WrapperStr,QString*> IdlSettings::_map_includes;
