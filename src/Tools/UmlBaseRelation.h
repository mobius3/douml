...
private:
    ...
    WrapperStr _default_value;

    UmlClass * _role_type;

    WrapperStr _role_name;
...
protected:
    ...
    UmlBaseRelation(void * id, const WrapperStr & n);

};

inline UmlBaseRelation::UmlBaseRelation(void * id, const WrapperStr & n) : UmlClassMember(id, n)
{
    _role_type = 0;
    _get_oper = 0;
    _set_oper = 0;
