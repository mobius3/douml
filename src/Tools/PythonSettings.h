...
public:
    ...
    static const WrapperStr & relationDecl(bool composition, const char * multiplicity);

    // set the default definition of a relation
    //
    // On error : return FALSE in C++, produce a RuntimeException in Java
    static bool set_RelationDecl(bool composition, const char * multiplicity, WrapperStr v);
