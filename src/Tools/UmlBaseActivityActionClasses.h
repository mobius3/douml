...
protected:
    ...
    UmlBaseSendObjectAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseUnmarshallAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseSendSignalAction(void * id, const WrapperStr & s) : UmlOnSignalAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseBroadcastSignalAction(void * id, const WrapperStr & s) : UmlOnSignalAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseValueSpecificationAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }


public:
    // return the value
    const WrapperStr & value();
...
#ifdef WITHCPP
    WrapperStr _cpp_value;
#endif

#ifdef WITHJAVA
    WrapperStr _java_value;
#endif
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseOpaqueAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }


public:
    // return the behavior
    const WrapperStr & behavior();
...
private:
    WrapperStr _behavior;

#ifdef WITHCPP
    WrapperStr _cpp_behavior;
#endif

#ifdef WITHJAVA
    WrapperStr _java_behavior;
#endif
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseAcceptEventAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
#ifdef WITHCPP
    WrapperStr _cpp_trigger;
#endif

#ifdef WITHJAVA
    WrapperStr _java_trigger;
#endif
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseCallOperationAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseCallBehaviorAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseClearVariableValueAction(void * id, const WrapperStr & s) : UmlAccessVariableValueAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseReadVariableValueAction(void * id, const WrapperStr & s) : UmlAccessVariableValueAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseWriteVariableValueAction(void * id, const WrapperStr & s) : UmlAccessVariableValueAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseAddVariableValueAction(void * id, const WrapperStr & s) : UmlAccessVariableValueAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseRemoveVariableValueAction(void * id, const WrapperStr & s) : UmlAccessVariableValueAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseAcceptCallAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseReplyAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }


public:
    // return the replyToCall trigger
    const WrapperStr & replyToCall();
    ...
    const WrapperStr & cppReplyToCall();
    ...
    const WrapperStr & javaReplyToCall();
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseCreateObjectAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }


public:
    // return the classifier
    const WrapperStr & classifier();
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseDestroyObjectAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseTestIdentityAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseRaiseExceptionAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
...
protected:
    //  the constructor, do not call it yourself !!!!!!!!!!
    UmlBaseReduceAction(void * id, const WrapperStr & s) : UmlActivityAction(id, s) {
    }
