...
QHash<QString, UmlBuiltin*> UmlSettings::_map_builtins;

UmlBuiltin * UmlSettings::_builtins;

QHash<QString, UmlStereotype*> UmlSettings::_map_relation_attribute_stereotypes;

UmlStereotype * UmlSettings::_relation_attribute_stereotypes;

QHash<QString, UmlStereotype*> UmlSettings::_map_class_stereotypes;
