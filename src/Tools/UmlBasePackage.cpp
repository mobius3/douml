...
WrapperStr UmlBasePackage::phpNamespace()
{
    read_if_needed_();
...
bool UmlBasePackage::set_PhpNamespace(const WrapperStr & s)
{
    return set_it_(_php_namespace, s, setPhpNamespaceCmd);
}

UmlPackage * UmlBasePackage::findPhpNamespace(const WrapperStr & n) const
{
