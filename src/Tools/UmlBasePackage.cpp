...
Q3CString UmlBasePackage::phpNamespace() {
  read_if_needed_();
  
  return _php_namespace;
}

bool UmlBasePackage::set_PhpNamespace(const Q3CString & s) {
  return set_it_(_php_namespace, s, setPhpNamespaceCmd);
}

UmlPackage * UmlBasePackage::findPhpNamespace(const Q3CString & n) const {
