...
ArtifactDialog::ArtifactDialog(ArtifactData * nd)
  ...
  kvtable = GridConverter::PlaceWidget(new KeyValuesTable((BrowserArtifact *) data->get_browser_node(),
...
void ArtifactDialog::init_cpp_tab() {
  ...
  vbox = GridConverter::PlaceVertical(cpp_h_content_page); 
  ...
  vbox = GridConverter::PlaceVertical(cpp_src_content_page); 
...
void ArtifactDialog::init_java_tab() {
  ...
  vbox = GridConverter::PlaceVertical(java_content_page); 
...
void ArtifactDialog::init_php_tab() {
  ...
  vbox = GridConverter::PlaceVertical(php_content_page); 
...
void ArtifactDialog::init_python_tab() {
  ...
  vbox = GridConverter::PlaceVertical(python_content_page); 
...
void ArtifactDialog::init_idl_tab() {
  ...
  vbox = GridConverter::PlaceVertical(idl_content_page); 
...
void ArtifactDialog::init_assoc_classes_tab() {
  ...
  cl_assoc_page = GridConverter::PlaceVertical(this);
  
  if (!visit) {
    hbox = GridConverter::PlaceHorizontal(cl_assoc_page);
...
void ArtifactDialog::init_assoc_artifacts_tab() {
  ...
  art_assoc_page = GridConverter::PlaceVertical(this);
  
  if (!visit) {
    hbox = GridConverter::PlaceHorizontal(art_assoc_page); 
    hbox->setMargin(5);
