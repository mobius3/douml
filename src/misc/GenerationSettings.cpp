...
void GenerationSettings::read_declaration_defaults()
{
    ...
    CPP_H_CONTENT = settings.value("Main/CPP_H_CONTENT").toString();
    CPP_SRC_CONTENT = settings.value("Main/CPP_SRC_CONTENT").toString();
    JAVA_SRC_CONTENT = settings.value("Main/JAVA_SRC_CONTENT").toString();
    PHP_SRC_CONTENT = settings.value("Main/PHP_SRC_CONTENT").toString();
    PYTHON_SRC_CONTENT = settings.value("Main/PYTHON_SRC_CONTENT").toString();
    IDL_SRC_CONTENT = settings.value("Main/IDL_SRC_CONTENT").toString();
    CPP_ATTR_DECL1 = settings.value("Main/CPP_ATTR_DECL1").toString();
    CPP_ATTR_DECL2 = settings.value("Main/CPP_ATTR_DECL2").toString();
    CPP_ATTR_DESCR1 = settings.value("Main/CPP_ATTR_DESCR1").toString();
    CPP_ATTR_DESCR2 = settings.value("Main/CPP_ATTR_DESCR2").toString();
    CPP_INDENT_VISIBILITY = settings.value("Main/CPP_INDENT_VISIBILITY").toString();
    JAVA_ATTR_DECL1 = settings.value("Main/JAVA_ATTR_DECL1").toString();
    JAVA_ATTR_DECL2 = settings.value("Main/JAVA_ATTR_DECL2").toString();
    JAVA_ATTR_DESCR1 = settings.value("Main/JAVA_ATTR_DESCR1").toString();
    JAVA_ATTR_DESCR2 = settings.value("Main/JAVA_ATTR_DESCR2").toString();
    PHP_CLASS = settings.value("Main/PHP_CLASS").toString();
    PHP_ENUM = settings.value("Main/PHP_ENUM").toString();
    PHP_INTERFACE = settings.value("Main/PHP_INTERFACE").toString();
    PHP_ATTR = settings.value("Main/PHP_ATTR").toString();
    PHP_ENUMITEM = settings.value("Main/PHP_ENUMITEM").toString();
    PHP_REL = settings.value("Main/PHP_REL").toString();
    PHP_OPER = settings.value("Main/PHP_OPER").toString();
    PYTHON_INDENT_STEP_ = settings.value("Main/PYTHON_INDENT_STEP").toString();
    PYTHON_CLASS = settings.value("Main/PYTHON_CLASS").toString();
    PYTHON_ENUM = settings.value("Main/PYTHON_ENUM").toString();
    PYTHON_ATTR1 = settings.value("Main/PYTHON_ATTR1").toString();
    PYTHON_ATTR2 = settings.value("Main/PYTHON_ATTR2").toString();
    PYTHON_ENUMITEM = settings.value("Main/PYTHON_ENUMITEM").toString();
    PYTHON_REL1 = settings.value("Main/PYTHON_REL1").toString();
    PYTHON_REL2 = settings.value("Main/PYTHON_REL2").toString();
    PYTHON_REL_COMP = settings.value("Main/PYTHON_REL_COMP").toString();
    PYTHON_OPER = settings.value("Main/PYTHON_OPER").toString();
    PYTHON_INITOPER = settings.value("Main/PYTHON_INITOPER").toString();
    IDL_EXTERNAL_CLASS_DECL = settings.value("Main/IDL_EXTERNAL_CLASS_DECL").toString();
    IDL_VALUETYPE_DECL = settings.value("Main/IDL_VALUETYPE_DECL").toString();
    IDL_ATTR_DECL1 = settings.value("Main/IDL_ATTR_DECL1").toString();
    IDL_ATTR_DECL2 = settings.value("Main/IDL_ATTR_DECL2").toString();
    IDL_ATTR_DESCR1 = settings.value("Main/IDL_ATTR_DESCR1").toString();
    IDL_ATTR_DESCR2 = settings.value("Main/IDL_ATTR_DESCR2").toString();
    IDL_VALUETYPE_ATTRIBUTE_DECL0 = settings.value("Main/IDL_VALUETYPE_ATTRIBUTE_DECL0").toString();
    IDL_VALUETYPE_ATTRIBUTE_DECL1 = settings.value("Main/IDL_VALUETYPE_ATTRIBUTE_DECL1").toString();
    IDL_VALUETYPE_ATTRIBUTE_DECL2 = settings.value("Main/IDL_VALUETYPE_ATTRIBUTE_DECL2").toString();
    IDL_VALUETYPE_ATTRIBUTE_DESCR1 = settings.value("Main/IDL_VALUETYPE_ATTRIBUTE_DESCR1").toString();
    IDL_VALUETYPE_ATTRIBUTE_DESCR2 = settings.value("Main/IDL_VALUETYPE_ATTRIBUTE_DESCR2").toString();
    IDL_CONST_ATTR_DECL1 = settings.value("Main/IDL_CONST_ATTR_DECL1").toString();
    IDL_CONST_ATTR_DECL2 = settings.value("Main/IDL_CONST_ATTR_DECL2").toString();
    IDL_CONST_ATTR_DESCR1 = settings.value("Main/IDL_CONST_ATTR_DESCR1").toString();
    IDL_CONST_ATTR_DESCR2 = settings.value("Main/IDL_CONST_ATTR_DESCR2").toString();
    IDL_UNION_ATTR_DECL1 = settings.value("Main/IDL_UNION_ATTR_DECL1").toString();
    IDL_UNION_ATTR_DECL2 = settings.value("Main/IDL_UNION_ATTR_DECL2").toString();
    IDL_UNION_ATTR_DESCR1 = settings.value("Main/IDL_UNION_ATTR_DESCR1").toString();
    IDL_UNION_ATTR_DESCR2 = settings.value("Main/IDL_UNION_ATTR_DESCR2").toString();
    IDL_VALUETYPE_REL_DECL0 = settings.value("Main/IDL_VALUETYPE_REL_DECL0").toString();
    IDL_VALUETYPE_REL_DECL1 = settings.value("Main/IDL_VALUETYPE_REL_DECL1").toString();
    IDL_VALUETYPE_REL_DECL2 = settings.value("Main/IDL_VALUETYPE_REL_DECL2").toString();
    IDL_VALUETYPE_REL_DESCR1 = settings.value("Main/IDL_VALUETYPE_REL_DESCR1").toString();
    IDL_VALUETYPE_REL_DESCR2 = settings.value("Main/IDL_VALUETYPE_REL_DESCR2").toString();
}
